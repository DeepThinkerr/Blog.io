...
<img src="%E5%9B%BE1.2.png" alt="图1.2" style="zoom:80%;" />
...
<img src="%E5%85%AC%E5%BC%8F1.1.png" alt="公式1.1" style="zoom:80%;" />
...
<img src="%E5%85%AC%E5%BC%8F1.2.png" alt="公式1.2" style="zoom:80%;" />

&emsp;&emsp;目标函数的min只是对样本的数据进行求最小值，可以对公式进行转换：

<img src="%E5%85%AC%E5%BC%8F1.3.png" alt="公式1.3" style="zoom:80%;" />
...
<img src="%E5%85%AC%E5%BC%8F1.4.png" alt="公式1.4" style="zoom:80%;" />
...
<img src="%E5%85%AC%E5%BC%8F1.5.png" alt="公式1.5" style="zoom:80%;" />

&emsp;&emsp;公式（1.5）是典型的凸优化问题，可以直接进行计算，但是当样本特征个数较多时，运算复杂。故引入拉格朗日乘子法得到公式（1.5）的对偶问题。

&emsp;&emsp;拉格朗日函数为：

<img src="%E5%85%AC%E5%BC%8F1.6.png" alt="公式1.6" style="zoom:80%;" />

&emsp;&emsp;其中，$\lambda_i>0$。故公式（1.6）带入公式（1.5）得：

<img src="%E5%85%AC%E5%BC%8F1.7.png" alt="公式1.7" style="zoom:80%;" />
...
<img src="%E5%85%AC%E5%BC%8F1.8.png" alt="公式1.8" style="zoom:80%;" />

&emsp;&emsp;将公式（1.8）带入公式（1.7）可得：

<img src="%E5%85%AC%E5%BC%8F1.9.png" alt="公式1.9" style="zoom:80%;" />

&emsp;&emsp;在进行对偶问题转换过程中，需要保证满足强对偶关系，即KKT条件，如下式所示。

<img src="%E5%85%AC%E5%BC%8F1.10.png" alt="公式1.10" style="zoom:80%;" />
